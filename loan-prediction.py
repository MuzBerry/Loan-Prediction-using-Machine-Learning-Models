...
animation_header = load_lottie(
    "https://assets6.lottiefiles.com/packages/lf20_azmc2roh.json")
animation_header2 = load_lottie(
    "https://assets4.lottiefiles.com/packages/lf20_1wnliqn0.json")
...
animation_contact = load_lottie(
    "https://assets4.lottiefiles.com/packages/lf20_mwawjro9.json")
st.write('---')
...
with st.container():
    ...
    with right_column:
        ...
        st.info(
            '[Mohammed Amarnath 612004](mailto:{Mohammedquresh.612004.it@mhssce.ac.in})', icon="📩")
        st.info(
            '[Muzammil Baloch 612012](mailto:{muzammil.612012.it@mhssce.ac.in})', icon="📩")
        st.info(
            '[Farhan Bastivi 612013](mailto:{mohammedfarhan.612013.it@mhssce.ac.in})', icon="📩")
        st.info(
            '[Dansih Fakira 612017](mailto:{mohammeddanish.612017.it@mhssce.ac.in})', icon="📩")
        st.info(
            '[Maanav Gupta 612019](mailto:{maanav.612019.it@mhssce.ac.in})', icon="📩")
    with left_column:
